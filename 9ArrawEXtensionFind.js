let nameArray = ["Fname1", "name2", "name3","jill", "tom"];
...
// console.log(nameArray.filter(element => element.length<4));
...
//console.log(longerLNames);prints all Array Objects which matches condition
